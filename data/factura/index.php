...
<html lang="es">
	...
	<body>
		...
		<div id="modal-factura" class="modal hide fade" tabindex="-1">
			...
			<div class="modal-body overflow-visible">
				<div class="row-fluid center">
					...
					<input type="hidden" id="txt_id_reservacion">
					<select id="sel_forma_pago">
						<option value=""></option>
			...
			<div class="modal-footer">
				...
				<button class="btn btn-small btn-success pull-left" id="btn_guardar_info">
						<i class="icon-save"></i>
						GUARDAR INFORMACIÓN
				</button>
			</div>
