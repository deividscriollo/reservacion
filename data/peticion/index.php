	...
	<body>
		...
		<div id="modal-form" class="modal hide" tabindex="-1">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-small btn-danger" id="btn_descartar">
					<i class="icon-remove"></i>
					No disponible
				</button>
		...
		<div id="modal-negado" class="modal hide" tabindex="-1">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="blue bigger">Envio mensaje no disponible</h4>
			</div>

			<div class="modal-body">
				<div class="row-fluid">
					<label for="form-field-11">Mensaje</label>
					<textarea  class="span12" id="txt_mensaje_negado" rows="7"></textarea>
					Att: Administrador Fabrica Imbabura
			...
			<div class="modal-footer">
				...
				<button class="btn btn-small btn-success" id="btn_confirmar_reservacion">
